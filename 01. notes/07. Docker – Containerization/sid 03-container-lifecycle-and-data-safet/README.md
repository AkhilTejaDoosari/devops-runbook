...
| [Container Lifecycle & Data Safety](../03-container-lifecycle-and-data-safety/README.md)
...
This section is an overview of how Docker is commonly used to run existing software such as databases, operating systems, and CLI tools. The goal is not to explain Docker internals, but to build correct instincts around container lifecycle and data safety before going deeper.


This file is optional for execution, but non-optional for understanding.
- This file does not teach you new mechanics.
- It teaches you how to think before touching mechanics.
